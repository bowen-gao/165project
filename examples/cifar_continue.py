...
def get_cifar10_loaders(data_aug=False, batch_size=128, test_batch_size=1000, perc=1.0, train_num=500, oracle_num=5000):
    if data_aug:
...
def accuracy(model, dataset_loader, tol, type):
    ...
    if type == "train":
        return total_loss / len(dataset_loader), total_correct / 500
    else:
...
class NODEIMG(nn.Module):
    ...
    def __init__(self):
        ...
        self.downconv1 = nn.Conv2d(3, 64, 3, 1)
